...
RSpec.describe Recipe, type: :model do
  it 'should create a valid recipe' do
    user = User.create(name: 'Ruth Doe', email: 'ruth@example.com', password: 'password', confirmed_at: Time.now)
    recipe = user.recipes.create(name: 'koko', description: 'Delicious')
